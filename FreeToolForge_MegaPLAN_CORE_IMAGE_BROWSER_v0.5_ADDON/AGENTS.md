...
- Canonical browser test: `python tests/browser-e2e.py`.
- It runs the production HTML/CSS/JS inside real Chromium through Playwright without relying on blocked network navigation.
- The test covers search, routing, representative execution paths, real image-file workflows, every live tool's runnable shell, mobile layout, and page/console error capture.
