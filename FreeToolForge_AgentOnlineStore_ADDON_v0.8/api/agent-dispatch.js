...
export default async function handler(req,res){
 ...
 for(const k of ['GITHUB_ACTIONS_DISPATCH_TOKEN','GITHUB_OWNER','GITHUB_REPO'])if(!process.env[k])return json(res,503,{error:'Autonomous Actions is not configured on this deployment.'});
